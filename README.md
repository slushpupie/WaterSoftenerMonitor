...
Next, set up some metrics gathering service to obtain the numbers.  Ive used Datadog, Telegraf/InfluxDB/Grafana, and Promethous in various itterations.  Currently, using SmartThings with a custom device type[2] to monitor it.

[1] https://www.modmypi.com/blog/hc-sr04-ultrasonic-range-sensor-on-the-raspberry-pi 
[2] https://github.com/slushpupie/MySmartThings/blob/master/devicetypes/slushpupie/watersoftenersensor.src/watersoftenersensor.groovy
